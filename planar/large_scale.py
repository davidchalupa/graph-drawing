...
if __name__ == "__main__":
    ...
    # G_demo = load_from_col_file("data/gplus_200.col")
    # print(f"Loaded a graph with {G_demo.number_of_nodes()} nodes and {G_demo.number_of_edges()} edges.")
    ...
    # title = "Radial HDE layout"

    # positions = compute_spectral_refined_layout(G_demo)
    # title = "Refined spectral layout"
